    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
              ...
              <a-row :gutter="24">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item label="支出账户" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-select placeholder="请选择支出账户" showSearch allow-clear optionFilterProp="children" v-model="queryParam.accountId">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item label="支出项目" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-select placeholder="请选择支出项目" showSearch allow-clear optionFilterProp="children" v-model="queryParam.inOutItemId">
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-button v-if="checkFlag && btnEnableList.indexOf(2)>-1" icon="check" @click="batchSetStatus(1, 'ItemOutList')">付款</a-button>
          <a-button v-if="checkFlag && btnEnableList.indexOf(7)>-1" icon="stop" @click="batchSetStatus(0, 'ItemOutList')">取消付款</a-button>
  ...
  export default {
    ...
    data () {
      return {
        ...
        columns: [
          ...
          { title: '支出项目', dataIndex: 'itemNames',width:160},
    ...
    methods: {
      ...
      applyRouteParams(params) {
        const { accountId, status, inOutItemId, beginDate, endDate } = params
